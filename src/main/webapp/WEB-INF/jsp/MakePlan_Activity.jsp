        ...
        <div class="container">
            ...
            <div class="col-md-9">
                <div class="col-md-12 portlet light">
                    <form class="sky-form" action="/activity" method="post">
                            ...
                            <section>
                                ...
                                <label class="input">
                                    ...
                                    <div class="input-group date form_datetime" style="margin-left :0px;">
                                        ...
                                        <input type="text" size="16" readonly class="form-control" name="startDateTime">
                            ...
                            <section>
                                ...
                                <label class="input">
                                    ...
                                    <div class="input-group date form_datetime" style="margin-left :0px;">
                                        ...
                                        <input type="text" size="16" readonly class="form-control" name="endDateTime">
												                            <span class="input-group-btn">
												                                <button class="btn default date-set"
                                                                                        type="button"><i
                                                                                        class="fa fa-calendar"></i>
