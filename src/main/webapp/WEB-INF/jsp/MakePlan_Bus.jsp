      ...
      <div class="col-md-9">
        <div class="portlet light">
          <div class="portlet-body">
            <div class="row">
              <div class="col-md-12">
                <form  class="sky-form" action = "/bus" method="post" >
                  <header>Bus Info</header>
                  <fieldset>
                    <section>
                      <label>Bus Company</label>
                      <label class="input">
                        <input tpye="text" name="busCompany"/>
                      </label>
                    ...
                    <section>
                      ...
                      <label class="input">
                        <div class="input-group date form_datetime" style="margin-left :0px;">
                          <input type="text" size="16" readonly class="form-control" name = "departureDateTime"/>
                    ...
                    <section>
                      ...
                      <label class="input">
                        <div class="input-group date form_datetime" style="margin-left :0px;">
                          <input type="text" size="16" readonly class="form-control" name="arrivalDateTime"/>
												  <span class="input-group-btn">
													  <button class="btn default date-set" type="button">
                                                        <i class="fa fa-calendar"></i>
                                                      </button>
