            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="portlet light">
                        <form class="sky-form" action="/MakePlan" method="post">
                            <header>Make Plan</header>
                            <fieldset>
                                <section>
                                    <label>Plan Name</label>
                                    <label class="input">
                                        <input type="text" name="planSubject"/>
                                    </label>
                                </section>
                                <section>
                                ...
                                <section>
                                    ...
                                    <label class="select">
                                        <select name="thema">
                                            ...
                                            <option value="2">홀로여행</option>
                                            <option value="3">연인과 함께</option>
                                            <option value="4">친구들과 함께</option>
                                            <option value="5">가족과 함꼐</option>
                                        </select>
                                        <i></i>
                                    </label>
                                </section>
                                ...
                                <section>
                                    ...
                                    <label class="input">
                                        ...
                                        <div class="input-group date form_datetime">
                                            <input type="text" size="16" readonly class="form-control" name="endDate"/>
										    <span class="input-group-btn">
											    <button class="btn default date-set" type="button">
                                                    <i class="fa fa-calendar"></i>
                                                </button>
